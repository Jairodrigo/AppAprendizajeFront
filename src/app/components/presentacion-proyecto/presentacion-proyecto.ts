...
@Component({
  selector: 'app-presentacion-proyecto',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './presentacion-proyecto.html',
  styleUrls: ['./presentacion-proyecto.css']
})
export class PresentacionProyecto implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.route.params.subscribe(params => {
      ...
      this.apiService.getUsuarioActual().subscribe({
        ...
        error: (err) => {
          console.error('No hay sesión activa o error al obtener usuario:', err);
          this.cargando = false;
        }
      });
    });
